...
const SolarViabilityProject = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative h-[70vh] bg-gradient-to-br from-blue-50 to-green-50 flex items-center">
        <div className="absolute inset-0 bg-gradient-to-r from-black/20 to-transparent"></div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <div className="mb-6">
              <Button asChild variant="ghost" size="sm" className="mb-4 text-gray-600 hover:text-blue-600">
            ...
            <h4 className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed">
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-8">
              <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                ...
                <p className="mb-4">
                  <strong>Study Objective:</strong> This comprehensive analysis evaluates solar feasibility for typical residential consumers in Assam, utilizing real-world consumption patterns, local irradiance data, and current policy frameworks to provide actionable insights.
                </p>
                
                <p className="mb-4">
                  <strong>Methodology:</strong> Our approach combines PVsyst modeling with NASA TMY meteorological data, incorporating actual utility tariffs, inflation projections, and available subsidies to deliver precise financial projections.
                </p>
                
                <p>
                  <strong>Key Finding:</strong> Rooftop solar installations demonstrate strong economic viability with payback periods of 6-7 years, delivering substantial long-term savings while contributing to India's renewable energy transition.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl font-semibold">📈 Data Collection</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl font-semibold">⚙ PVsyst Analysis</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-gray-600">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl font-semibold">💰 Financial Modeling</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-gray-600">
            ...
            <CardContent className="p-8">
              <div className="h-96 bg-gradient-to-br from-blue-50 to-green-50 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Interactive Calculator</h3>
                  <p className="text-gray-600 mb-6">Input your location and consumption to calculate your payback, savings, and subsidy.</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg overflow-hidden">
              ...
              <CardContent className="p-4">
                <p className="text-sm text-gray-600">PVsyst simulation snapshot showing optimal tilt and orientation analysis</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg overflow-hidden">
              ...
              <CardContent className="p-4">
                <p className="text-sm text-gray-600">Waaree 545Wp panel installation on typical Assam residence</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg overflow-hidden">
              ...
              <CardContent className="p-4">
                <p className="text-sm text-gray-600">Financial model dashboard showing 25-year projections and ROI analysis</p>
              </CardContent>
            </Card>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-600">thesubhrajyotimahanta@gmail.com</span>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="h-5 w-5 text-gray-400" />
                  <span className="text-gray-600">+91 6002967278</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://github.com/Subhrajyouti" className="text-gray-400 hover:text-gray-600">
                  <Github className="h-6 w-6" />
                </a>
                <a href="https://www.linkedin.com/in/subhrajyotimahanta/" className="text-gray-400 hover:text-gray-600">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Project Credits</h3>
              <p className="text-gray-600">Designed and developed by</p>
              <p className="font-semibold text-gray-900">Subhrajyoti Mahanta</p>
